...
export interface PostGeneratorEvents {
  'senkron:post-generated': CustomEvent<{ platform: SocialPlatform; draft: PostDraft }>;
  'senkron:post-copied': CustomEvent<{ platform: SocialPlatform; text: string }>;
  'senkron:post-applied': CustomEvent<PostAppliedDetail>;
  'senkron:modal-close': CustomEvent<void>;
  'senkron:post-error': CustomEvent<{ message: string }>;
}
