...
const lt = (n) => new nt(typeof n == "string" ? n : n + "", void 0, B), Rt = (n, ...t) => {
...
}, F = I ? (n) => n : (n) => n instanceof CSSStyleSheet ? ((t) => {
  let e = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: dt, defineProperty: ut, getOwnPropertyDescriptor: pt, getOwnPropertyNames: $t, getOwnPropertySymbols: ft, getPrototypeOf: _t } = Object, _ = globalThis, K = _.trustedTypes, yt = K ? K.emptyScript : "", D = _.reactiveElementPolyfillSupport, w = (n, t) => n, R = { toAttribute(n, t) {
  switch (t) {
    case Boolean:
      n = n ? yt : null;
      break;
  ...
  return e;
} }, q = (n, t) => !dt(n, t), Z = { attribute: !0, type: String, converter: R, reflect: !1, useDefault: !1, hasChanged: q };
...
let v = class extends HTMLElement {
  ...
  _$AK(t, e) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const a = s.getPropertyOptions(i), h = typeof a.converter == "function" ? { fromAttribute: a.converter } : ((r = a.converter) == null ? void 0 : r.fromAttribute) !== void 0 ? a.converter : R;
      this._$Em = i;
  ...
  requestUpdate(t, e, s, i = !1, r) {
    ...
    if (t !== void 0) {
      ...
      if (i === !1 && (r = this[t]), s ?? (s = a.getPropertyOptions(t)), !((s.hasChanged ?? q)(r, e) || s.useDefault && s.reflect && r === ((o = this._$Ej) == null ? void 0 : o.get(t)) && !this.hasAttribute(a._$Eu(t, s)))) return;
      this.C(t, e, s);
    }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const C = globalThis, J = (n) => n, N = C.trustedTypes, G = N ? N.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, rt = "$lit$", f = `lit$${Math.random().toFixed(9).slice(2)}$`, ot = "?" + f, At = `<${ot}>`, m = document, P = () => m.createComment(""), x = (n) => n === null || typeof n != "object" && typeof n != "function", V = Array.isArray, gt = (n) => V(n) || typeof (n == null ? void 0 : n[Symbol.iterator]) == "function", L = `[ 	
\f\r]`, S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Q = /-->/g, X = />/g, y = RegExp(`>|${L}(?:([^\\s"'>=/]+)(${L}*=${L}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Y = /'/g, tt = /"/g, ht = /^(?:script|style|textarea|title)$/i, mt = (n) => (t, ...e) => ({ _$litType$: n, strings: t, values: e }), kt = mt(1), E = Symbol.for("lit-noChange"), u = Symbol.for("lit-nothing"), et = /* @__PURE__ */ new WeakMap(), A = m.createTreeWalker(m, 129);
function at(n, t) {
...
const vt = (n, t) => {
  ...
  for (let a = 0; a < e; a++) {
    const h = n[a];
    let c, d, l = -1, p = 0;
    for (; p < h.length && (o.lastIndex = p, d = o.exec(h), d !== null); ) p = o.lastIndex, o === S ? d[1] === "!--" ? o = Q : d[1] !== void 0 ? o = X : d[2] !== void 0 ? (ht.test(d[2]) && (i = RegExp("</" + d[2], "g")), o = y) : d[3] !== void 0 && (o = y) : o === y ? d[0] === ">" ? (o = i ?? S, l = -1) : d[1] === void 0 ? l = -2 : (l = o.lastIndex - d[2].length, c = d[1], o = d[3] === void 0 ? y : d[3] === '"' ? tt : Y) : o === tt || o === Y ? o = y : o === Q || o === X ? o = S : (o = y, i = void 0);
    const $ = o === y && n[a + 1].startsWith("/>") ? " " : "";
    r += o === S ? h + At : l >= 0 ? (s.push(c), h.slice(0, l) + rt + h.slice(l) + f + $) : h + f + (l === -2 ? a : $);
  }
...
class U {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let r = 0, o = 0;
    const a = t.length - 1, h = this.parts, [c, d] = vt(t, e);
    ...
    for (; (i = A.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(rt)) {
          const p = d[o++], $ = i.getAttribute(l).split(f), M = /([.?@])?(.*)/.exec(p);
          h.push({ type: 1, index: r, name: M[2], strings: $, ctor: M[1] === "." ? bt : M[1] === "?" ? St : M[1] === "@" ? wt : k }), i.removeAttribute(l);
        ...
        if (ht.test(i.tagName)) {
          ...
          if (p > 0) {
            ...
            for (let $ = 0; $ < p; $++) i.append(l[$], P()), A.nextNode(), h.push({ type: 2, index: ++r });
            i.append(l[p], P());
          }
        }
...
class Et {
  ...
  u(t) {
    ...
    for (; h !== void 0; ) {
      if (o === h.index) {
        let c;
        h.type === 2 ? c = new O(r, r.nextSibling, this, t) : h.type === 1 ? c = new h.ctor(r, h.name, h.strings, this, t) : h.type === 6 && (c = new Ct(r, this, t)), this._$AV.push(c), h = s[++a];
      }
...
class O {
  ...
  _$AI(t, e = this) {
    t = b(this, t, e), x(t) ? t === u || t == null || t === "" ? (this._$AH !== u && this._$AR(), this._$AH = u) : t !== this._$AH && t !== E && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : gt(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class k {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let o = !1;
    if (r === void 0) t = b(this, t, e, 0), o = !x(t) || t !== this._$AH && t !== E, o && (this._$AH = t);
    else {
      const a = t;
      let h, c;
      for (t = r[0], h = 0; h < r.length - 1; h++) c = b(this, a[s + h], e, h), c === E && (c = this._$AH[h]), o || (o = !x(c) || c !== this._$AH[h]), c === u ? t = u : t !== u && (t += (c ?? "") + r[h + 1]), this._$AH[h] = c;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
j == null || j(U, O), (C.litHtmlVersions ?? (C.litHtmlVersions = [])).push("3.3.3");
const Pt = (n, t, e) => {
...
var it;
H._$litElement$ = !0, H.finalized = !0, (it = g.litElementHydrateSupport) == null || it.call(g, { LitElement: H });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const xt = { attribute: !0, type: String, converter: R, reflect: !1, hasChanged: q }, Ut = (n = xt, t, e) => {
...
function Ot(n) {
  return (t, e) => typeof e == "object" ? Ut(n, t, e) : ((s, i, r) => {
...
const Mt = 'button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])';
function Tt(n) {
  const { focusableCount: t, activeIndex: e, shiftKey: s } = n;
  return t === 0 ? "none" : s && (e === 0 || e === -1) ? "wrap-last" : !s && e === t - 1 ? "wrap-first" : "none";
}
function st(n) {
  const t = [], e = (s) => {
    for (const i of Array.from(s.children))
      i instanceof HTMLElement && (i.matches(Mt) && !i.hasAttribute("disabled") && t.push(i), i.shadowRoot && e(i.shadowRoot));
  };
  return e(n), t;
}
class Lt {
  constructor(t, e) {
    this.host = t, this.close = e, this.previouslyFocused = null, this.handleKeydown = (s) => {
      var c, d, l;
      ...
      const i = this.dialog();
      if (!i) return;
      const r = st(i), o = (c = this.host.shadowRoot) == null ? void 0 : c.activeElement, a = o ? r.indexOf(o) : -1, h = Tt({
        focusableCount: r.length,
        activeIndex: a,
        shiftKey: s.shiftKey
      });
      h === "wrap-last" ? (s.preventDefault(), (d = r[r.length - 1]) == null || d.focus()) : h === "wrap-first" && (s.preventDefault(), (l = r[0]) == null || l.focus());
    };
  }
  async openChanged(t) {
    if (t) {
      this.previouslyFocused = typeof document < "u" ? document.activeElement : null, await this.host.updateComplete;
      const e = this.dialog(), s = e ? st(e)[0] : null;
      s == null || s.focus();
    } else {
      const e = this.previouslyFocused;
      this.previouslyFocused = null, e && typeof e.focus == "function" && e.isConnected && e.focus();
    }
  }
  dialog() {
    var t;
    return ((t = this.host.shadowRoot) == null ? void 0 : t.querySelector('[role="dialog"]')) ?? null;
  }
}
export {
  Lt as M,
